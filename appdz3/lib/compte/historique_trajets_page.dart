...
class _HistoriqueTrajetsPageState extends State<HistoriqueTrajetsPage> {
  ...
  Future<void> _fetchLignesFromFirestore() async {
    ...
    final nomsLignes = snapshot.docs
        ...
        .toList();
    setState(() {
      lignesDisponibles = ["Toutes les lignes", ...nomsLignes];
    });
  }

  void _resetFilters() {
    setState(() {
      _selectedLine = "Toutes les lignes";
      _selectedJour = "Tous les jours";
    });
  }
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: InputDecorator(
                  decoration: InputDecoration(
                    labelText: 'Filtrer par ligne',
                    border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)),
                    prefixIcon: const Icon(Icons.train),
                  ),
                  child: Text(
                    _selectedLine ?? "Choisir une ligne",
                    style: TextStyle(
                      color: _selectedLine != null ? Colors.black : Colors.grey,
                    ),
                  ),
                ),
              ),
              ...
              GestureDetector(
                ...
                child: InputDecorator(
                  ...
                  child: Text(
                    _selectedJour ?? "Choisir un jour",
                    style: TextStyle(
                      color: _selectedJour != null ? Colors.black : Colors.grey,
                    ),
                  ),
                ),
              ),
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    trailing: selectedValue == option
                        ...
                        : null,
                    onTap: () {
                      onSelected(option); // met à jour dans le parent
                      Navigator.pop(context); // ferme cette liste seulement
                    },
                  );
                },
              ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Mes trajets favoris", style: TextStyle(color: Colors.black)),
            ...
            child: Row(
              children: [
                ...
                ElevatedButton.icon(
                  ...
                  label: const Text("Filtres", style: TextStyle(color: Colors.black)),
                  style: ElevatedButton.styleFrom(
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasError) {
                  return Center(child: Text("Erreur : ${snapshot.error}", style: TextStyle(color: Colors.black)));
                }
                ...
                final trajets = allDocs.where((doc) {
                  ...
                  final matchesLine = _selectedLine == "Toutes les lignes" || _selectedLine == line;
                  final matchesJour = _selectedJour == "Tous les jours" || _selectedJour == jour;
                ...
                if (trajets.isEmpty) {
                  return const Center(
                    child: Text("Aucun trajet favori trouvé.", style: TextStyle(color: Colors.black)),
                  );
                }
                      ...
                      child: ListTile(
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            ...
                            Text("🕒 ${trajet['heureDepart']} → ${trajet['heureArrivee']}", style: const TextStyle(color: Colors.black)),
                            Text("🚆 Train : ${trajet['trainId']} | Ligne : ${trajet['lineId']}", style: const TextStyle(color: Colors.black)),
                            Text("🗓 Jour : ${trajet['jourDeCirculation']}", style: const TextStyle(color: Colors.black)),
                          ],
                        ),
                        trailing: IconButton(
